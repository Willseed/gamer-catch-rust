...
/// SHA-512 published in the npm registry metadata for playwright-core 1.60.0.
#[allow(dead_code)]
const PLAYWRIGHT_CORE_1_60_0_SHA512: &str = "f5b5bacef5ff9b49446e04ca27a629a4e2b1f07dd538f04c382161da2ad714e4f805b1e0af1e613e3c0960b4f8d0bbbee2ab43dfaa8a73f1e7e7a4ad516e7b20";
...
#[allow(dead_code)]
fn npm_core_sha512(driver_version: &str) -> Option<&'static str> {
    match driver_version {
        "1.60.0" => Some(PLAYWRIGHT_CORE_1_60_0_SHA512),
        _ => None,
    }
}

/// SHA-256 values from nodejs.org's signed SHASUMS256.txt for v24.17.0.
#[allow(dead_code)]
fn node_archive_sha256(node_version: &str, triple: &str) -> Option<&'static str> {
    if node_version != "24.17.0" {
        return None;
    }
    match triple {
        "darwin-arm64" => Some("4fc3266a3702eebc39cc37661cf4eeceeade307e242ab64e4d7ce7949197e11f"),
        "darwin-x64" => Some("80da552fe037290cb130e9dea590f5eeeb7aa450636f0c89ab41415511c1ec27"),
        "linux-arm64" => Some("faa0d59ba7fe7045c950ed09b190578fb8eee73e4358686d38fcc99ca58c1480"),
        "linux-x64" => Some("e0472427aa791ad80bdc426ff7cc73cdd28ed0f616d1ff9689a23a7f47f1265f"),
        "win-arm64" => Some("4957712f67fce55779cc794d9b4df9e0e802a18c841ad5a4e42f17be490e634d"),
        "win-x64" => Some("f2aa33b35b75aca5f3f7b85675a6f6423201053e9381911e64961f3bda2528ab"),
        _ => None,
    }
}
...
mod driver_urls_tests {
    ...
    #[test]
    fn every_supported_archive_has_a_pinned_checksum() {
        assert_eq!(npm_core_sha512("1.60.0").unwrap().len(), 128);
        for (_, _, _, triple) in ALL {
            assert_eq!(node_archive_sha256(NODE_VERSION, triple).unwrap().len(), 64);
        }
    }
}
